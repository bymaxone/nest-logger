...
| `err.stack`            | Scrubbed stack                | `exception.stacktrace` | **Stable** | Kept; dual-emitted                     |
...
| `exception.stacktrace` | Scrubbed stack                | `exception.stacktrace` | **Stable** | `errorFormat: 'semconv' \| 'both'`     |

...
| `destinations`               | `ILogDestination[]`             | `[]`           | The sinks entries are written to. ⚠️ A non-empty list **replaces** the default stdout sink — see [Destinations](#destinations-replace-stdout) |
